  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return  Scaffold(
        appBar: AppBar(
            ...
            body: Column(
              children: [
                selectedPost.when(data: (post)=>InkWell(
      onTap: () {
                    ...
                    : post.user?.userType == 'parent'?FutureBuilder(
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                if (!(post.likedBy?.contains(user.asData?.value.id) ??
                                    false)) {
                                  likePost(post, ref);
                                } else {
                                  unLikePost(post, ref);
                              ...
                              child: Row(
                                children: [
                                  Icon(
                                    post.likedBy?.contains(user.asData?.value.id) ?? false
                                        ? Icons.favorite
                            ...
                            Visibility(
                              visible: post.user?.userId ==user.asData?.value.id,
                              child: InkWell(
                                onTap: () {
                                  showDialog(
                                      context: context,
