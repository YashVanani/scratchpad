...
class PlayBookApply extends ConsumerStatefulWidget {
  PlayBookApply({super.key, required this.classId,required this.playbook});
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: ()async {
                        bool res = await applyStrategy(ref: ref,playbookId: widget.playbook.id??"",playbookTitle: widget.playbook.title?.en??"",time: selectedDate??DateTime.now(),message:messageController.text,classId: selectedClass??"" );
                        Navigator.pop(
                          context,
                        );
                        if(res){
