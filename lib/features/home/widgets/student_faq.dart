  ...
  Widget build(BuildContext context) {
     return StatefulBuilder(
      builder: (context, state) {
        ...
        Uri.parse(snapshot.data?.studentFaq?[index].videoUrl ?? ""))
      ..initialize().then((_) {
        // Ensure the first frame is shown after the video is initialized, even before the play button has been pressed.
        setState(() {});
      }));
                              return ExpansionTile(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      snapshot.data?.studentFaq?[index]
                                              .question ??
                                          "",
                                      style: TextStyle(
                                          fontSize: 12,
                                  ...
                                  SizedBox(height: 10,),
                                  snapshot.data?.studentFaq?[index].videoUrl==null || isVideoVisible[index]?SizedBox():Center(
                                     child: InkWell(
                                      onTap: (){
                                        setState(() {
                          ...
                          ( snapshot.data?.studentFaq?[index].videoUrl?.isNotEmpty ?? false) && isVideoVisible[index])
                  ? Container(
                      margin:
